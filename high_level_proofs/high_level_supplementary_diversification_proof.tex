...
% Patch longtable's \LT@output to use \vfil instead of \vss,
% eliminating "Infinite glue shrinkage" warnings on page breaks.
\makeatletter
...
\makeatletter
% theHtable/theHfigure not needed with hypertexnames=false
\makeatother
  ...
  \item \textbf{Theorem~\ref{thm:within-bucket}
        ...
        \begin{enumerate}[label=(\alph*), itemsep=2pt]
          ...
          \item The result extends to all nine buckets
                simultaneously; see Theorem~\ref{thm:within-bucket}
                in Chapter~7.
        \end{enumerate}
...
{\small
\begin{longtable}{@{} p{3.2cm} p{3.8cm} p{\dimexpr\textwidth-3.2cm-3.8cm-4\tabcolsep\relax} @{}}
\hline
\textbf{Symbol} & \textbf{Name} & \textbf{Description / First Use} \\
\hline
\endfirsthead
\hline
\textbf{Symbol} & \textbf{Name} & \textbf{Description / First Use (cont.)} \\
\hline
\endhead
\endfoot
$N$ & Number of assets &
...
{\small
\begin{longtable}{@{} p{2.4cm} p{5.2cm} p{\dimexpr\textwidth-2.4cm-5.2cm-4\tabcolsep\relax} @{}}
\hline
\textbf{Label} & \textbf{Name} & \textbf{Brief Statement / Purpose} \\
\hline
\endfirsthead
\hline
\textbf{Label} & \textbf{Name} & \textbf{Brief Statement / Purpose (cont.)} \\
\hline
\endhead
\endfoot
...
{\small
\begin{longtable}{@{} p{3.0cm} p{\dimexpr\textwidth-3.0cm-2\tabcolsep\relax} @{}}
\hline
\textbf{Abbreviation} & \textbf{Expansion and Context} \\
\hline
\endfirsthead
\hline
\textbf{Abbreviation} & \textbf{Expansion and Context (cont.)} \\
\hline
\endhead
\endfoot
