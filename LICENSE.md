...
This project is **source-available**, not open source in the OSI sense. It is distributed under a **modified Creative Commons Attribution-NonCommercial 4.0 International License (CC BY-NC 4.0)**, layered with the **Supplementary Proprietary Terms** in Section 2 of this document. Where the Supplementary Proprietary Terms and the CC BY-NC 4.0 legal code conflict, the Supplementary Proprietary Terms control.
...
- **Share** — copy and redistribute the material in any medium or format, subject to Section 2 below.
- **Adapt** — remix, transform, and build upon the material, subject to Section 2 below.
...
You do not have to comply with the license for elements of the material in the public domain or where your use is permitted by an applicable exception or limitation. No warranties are given; see Section 4 (Disclaimer of Warranty).
...
All contributions to this repository — code, documentation, or specification edits — **must** be made by:

1. Forking the upstream repository (`psi16181918161phi/X_Voice_X`);
2. Making changes on a branch within that fork;
3. Submitting a Pull Request back to the upstream repository.

Direct pushes to upstream branches are not permitted for non-maintainers. This requirement exists so that **every contribution is permanently and verifiably attributed** to its author via the fork's Git history and the resulting Pull Request record, in perpetuity, regardless of how the contribution is later modified, relicensed, or redistributed by the copyright holder. See [CONTRIBUTION.md](CONTRIBUTION.md) for the full workflow.

### 2.3. Contribution License Grant
...
### 2.4. No Sublicensing by Third Parties

Except for the license expressly granted in Section 1, no recipient of this material may sublicense, relicense, or grant others rights beyond what CC BY-NC 4.0 itself permits. Redistribution of forks must retain this LICENSE.md file, unmodified, in full.
...
THE MATERIAL IS PROVIDED "AS IS," WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NONINFRINGEMENT. IN NO EVENT SHALL THE COPYRIGHT HOLDER BE LIABLE FOR ANY CLAIM, DAMAGES, OR OTHER LIABILITY ARISING FROM, OUT OF, OR IN CONNECTION WITH THE MATERIAL OR THE USE OR OTHER DEALINGS IN THE MATERIAL, AS FURTHER DETAILED IN CC BY-NC 4.0 SECTIONS 5(A) AND 5(B) OF THE LEGAL CODE.
